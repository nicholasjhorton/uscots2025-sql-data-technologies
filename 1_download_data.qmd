---
title: "USCOTS 2025 breakout session: Download the airlines data"
...
This file downloads the airline flight data from the American Statistical Association's Data Expo 2024.
...
Once you've successfully rendered this Quarto file (`1_download_data.qmd`), open and render `2_explore-sql.qmd` to carry out an analysis of the downloaded data.
